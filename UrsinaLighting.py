...
class LitObject(Entity):
    def __init__(self, model='plane', scale=1, position=(0, 0, 0), rotation=(0, 0, 0), texture=None, collider=None,
                 ...
                 smoothness=128, ambientStrength=0.1, normalMap=None, specularMap=None, water=False,
                 cubemap="textures/cubemap_#.jpg", cubemapIntensity=0.5,
...
if __name__ == "__main__":
    ...
    ground = LitObject(model="plane", scale=10, texture=texture, specularMap=specTexture, normalMap=normTexture,
                       ambientStrength=0.5)
    cube = LitObject(model="cube", position=(0, 0.5, 1), texture="white_cube", specularMap=None, normalMap=None,
                     ambientStrength=0.5)
